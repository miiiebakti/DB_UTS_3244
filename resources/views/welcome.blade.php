...
<section class="max-w-7xl mx-auto px-6 py-20">
    <div class="text-center mb-12">
        ...
        <p class="text-slate-500">
            Platform kami didukung oleh berbagai partner terpercaya.
        </p>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <div class="bg-white rounded-3xl p-8 border border-slate-100 shadow-sm hover:shadow-xl transition">

            <!-- Logo Partner -->
            <img src="{{ $partner->logo_url }}"
                 alt="{{ $partner->name }}"
                 class="w-20 h-20 object-cover rounded-xl mb-4">
