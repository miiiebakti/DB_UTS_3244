...
<main class="max-w-3xl mx-auto px-6 py-20">
    ...
    <div class="grid grid-cols-1 gap-8">
        ...
        <div class="bg-white rounded-3xl border border-slate-200 p-8 shadow-sm">
            ...
            <h3 class="text-xl font-bold mb-2 italic text-indigo-600 underline underline-offset-8">
                📦 Data Pemesan
            </h3>

            <p class="text-sm text-slate-500 mb-6">
                Login menggunakan akun Google agar nama dan email terisi otomatis.
            </p>
            ...
            <form action="{{ route('checkout.store',$event->id) }}" method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    <input
                        ...
                        required
                        value="{{ session('customer_name', old('customer_name')) }}">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            class="w-full px-5 py-4 bg-white border-2 border-slate-100 rounded-2xl focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-600 outline-none transition font-medium"
                            required
                            value="{{ session('customer_email', old('customer_email')) }}">
