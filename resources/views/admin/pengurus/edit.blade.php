        ...
        <form action="{{ route('pengurus.update', $pengurus->id) }}"
            ...
            <div>
                ...
                <textarea
                    name="description"
                    rows="4"
                    class="w-full px-5 py-3 rounded-2xl border border-slate-300 focus:ring-2 focus:ring-indigo-500 outline-none">{{ old('description', $pengurus->description) }}</textarea>
            </div>
