    ...
    <div class="max-w-3xl mx-auto bg-white p-8 rounded-3xl shadow border">
        ...
        <div class="mb-8">
            ...
            <p class="text-slate-500">
                Perbarui data akun organizer AmikomEventHub.
            </p>
        ...
        <!-- FORM -->
        <form action="{{ route('organizers.update', $organizer->id) }}"
              method="POST"
              class="space-y-6">
            ...
            <div>
                ...
                <input
                    ...
                    value="Organizer"
                    readonly
                    class="w-full px-5 py-3 rounded-2xl bg-slate-100 border border-slate-300 text-slate-500 cursor-not-allowed">
            </div>
