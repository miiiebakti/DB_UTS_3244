...
<body class="bg-slate-50 text-slate-900">
        ...
        <div class="flex items-center gap-3">
            ...
            @auth
                ...
                <form
                    ...
                    <button
                        type="submit"
                        class="px-5 py-2.5 bg-red-500 text-white rounded-xl font-semibold shadow-lg shadow-red-100 hover:bg-red-600 transition">
    ...
    <footer class="bg-indigo-900 text-indigo-100 py-20 px-6 mt-20">
        ...
        <div
            class="max-w-7xl mx-auto pt-12 mt-12 border-t border-indigo-800 text-center text-indigo-400 text-sm">
